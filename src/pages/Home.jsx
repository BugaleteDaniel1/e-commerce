      ...
      <section className="landing-page">
        <header className="landing-header">
          ...
          <p className="landing-p">
            ...
            libero id? Tempore facilis voluptate id expedita porro? Laborum
            porro esse corrupti necessitatibus illum doloribus cumque, odio at
        ...
        <div className="image-container">
          <img src={HeroImg} alt="an image of an interior of a house" />
        </div>
      </section>
    </>
  );
